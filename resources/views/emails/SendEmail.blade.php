                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:20px;text-align:center;">
                                                        ...
                                                        <tbody>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width:150px;">
                                                                                    <img height="auto"
                                                                                        src="{{ asset('https://csserv.cs.psu.ac.th/image/brand.png') }}"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                    <div
                                                                        style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:30px;text-align:center;color:#000000;">
                                                                        {{ $details['message'] }}</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                            ...
                            <div
                                style="background:#eeeeee;background-color:#eeeeee;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="background:#eeeeee;background-color:#eeeeee;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                                                <div class="mj-column-per-100 mj-outlook-group-fix"
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    {{-- <div
                                                                        ...
                                                                        <h2 class="date"
                                                                            ...
                                                                            หมายเลขคำขอ:
                                                                            {{ $details['serviceRequestNumber'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            งานบริการ:
                                                                            {{ $details['serviceName'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            รายละเอียด:
                                                                            {{ $details['serviceDescription'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            ชั้นความเร็ว:
                                                                            {{ $details['servicePriority'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            หน่วยงาน:
                                                                            {{ $details['serviceDepartment'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            วันที่/เวลา:
                                                                            {{ $details['serviceDateTime'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            ผู้ขอใช้บริการ:
                                                                            {{ $details['to'] }}</h2>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            หมายเลขคำขอ:
                                                                            {{ $details['serviceRequestNumber'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            งานบริการ:
                                                                            {{ $details['serviceName'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            รายละเอียด:
                                                                            {{ $details['serviceDescription'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            ชั้นความเร็ว:
                                                                            {{ $details['servicePriority'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            หน่วยงาน:
                                                                            {{ $details['serviceDepartment'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            วันที่/เวลา:
                                                                            {{ $details['serviceDateTime'] }}</p>
                                                                        <p style="margin: 0 0 5px 0;">
                                                                            ผู้ขอใช้บริการ:
                                                                            {{ $details['to'] }}</p>
                                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                                <div class="mj-column-per-100 mj-outlook-group-fix"
                                                    style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                    <table cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" rules="all" style="border-color: #666;">
                                                        <tbody>
                                                            <tr>
                                                                <td align="left"
                                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
