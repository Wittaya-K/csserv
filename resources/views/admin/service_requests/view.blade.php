...
@section('content')
    ...
    <div class="row d-flex align-items-stretch">
                                        ...
                                        <select name="serviceProvider" id="serviceProvider" class="form-control select2"
                                            ...
                                            @foreach ($users as $user)
                                                @foreach ($serviceProviders as $serviceProvider)
                                                    @if ($serviceProvider->serviceProvider == $user->username && $serviceRequests->id == $serviceProvider->reqid)
                                                        <option value="{{ $serviceProvider->serviceProvider }}" selected>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endif
                                                @endforeach
        ...
        <div class="col-lg-4 col-12 d-flex">
            <div class="card card-secondary card-outline direct-chat direct-chat-secondary flex-fill">
                <div class="card-header bg-secondary">
                    <h3 class="card-title">
                        <i class="fad fa-comments-alt"></i> {{ $chatTitle }}
                    </h3>
                </div>
                                ...
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix">
                                        <span class="direct-chat-name float-left">
                                            <a href="#">{{ $ServiceRequestMessagesItem->requestMessageSender }}</a>
                                        </span>
                                        <span class="direct-chat-timestamp float-right">
                                            {{ $ServiceRequestMessagesItem->requestMessageDateTime }}
                                        </span>
                                    </div>
                ...
                <div class="card-footer">
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-primary" name="sendMessageBtn" id='sendMessageBtn'>
                            <i class="fad fa-paper-plane"></i> ส่ง
                        </button>
                    </div>
                </div>
            </div>
